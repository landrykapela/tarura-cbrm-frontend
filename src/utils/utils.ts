...
import { CustomTime, Group, GroupType, ILocation, IRequestStatusBadge, ISession, IUserData, Member } from "./types";
import { MdApproval, MdApps, MdAssessment, MdAssignment, MdAssignmentTurnedIn, MdCurtainsClosed, MdDangerous, MdDeleteSweep, MdDirectionsCar, MdExitToApp, MdNavigation, MdPeople, MdSettings, MdTimer } from "react-icons/md";
...
export const getGeodata = () : ILocation[]=>{
  return [
        {
            "name": "Kikundi Namba 1",
            "category": "Education",
            "description": "The oldest university in Tanzania.",
            "coordinates": {
                "latitude": -6.7867,
                "longitude": 39.2004
            },
        ...
        {
            "name": "Kikundi Namba 2",
            "category": "Transport",
            "description": "One of the largest ports in East Africa.",
            "coordinates": {
                "latitude": -6.7924,
                "longitude": 39.2037
            },
        ...
        {
            "name": "Kikundi Namba 3",
            "category": "Culture",
            "description": "Museum showcasing the country's cultural heritage.",
            "coordinates": {
                "latitude": -6.7943,
                "longitude": 39.2083
            },
        ...
        {
            "name": "Kikundi Namba 4",
            "category": "Market",
            "description": "A bustling market famous for fresh seafood.",
            "coordinates": {
                "latitude": -6.7860,
                "longitude": 39.2044
            },
        ...
        {
            "name": "Kikundi Namba 5",
            "category": "Recreation",
            "description": "A popular beach area for relaxation and water sports.",
            "coordinates": {
                "latitude": -6.7623,
                "longitude": 39.2652
            },
        ...
        {
            "name": "Kikundi Namba 6",
            "category": "Shopping",
            "description": "A major shopping mall with various retail stores.",
            "coordinates": {
                "latitude": -6.7485,
                "longitude": 39.2038
            },
        ...
        {
            "name": "Kikundi Namba 7",
            "category": "Art",
            "description": "Market known for local handicrafts and sculptures.",
            "coordinates": {
                "latitude": -6.7739,
                "longitude": 39.2085
            },
        ...
        {
            "name": "Kikundi Namba 8",
            "category": "Business",
            "description": "Venue for international conferences and events.",
            "coordinates": {
                "latitude": -6.7948,
                "longitude": 39.2089
            },
...
export const generateMembers = ()=>{
  const sampleMembers: Member[] = [
    { id: 1, name: "Alice Mwangi", phone: "0712345678", group: "Kikundi Namba 1", date: "2023-01-01", region: "Dar es Salaam", district: "Kinondoni", gender: "Female", status: "Married" },
    { id: 2, name: "Bob Chuma", phone: "0789456123", group: "Kikundi Namba 2", date: "2023-01-02", region: "Dar es Salaam", district: "Temeke", gender: "Male", status: "Not Married" },
    { id: 3, name: "Catherine Ndugu", phone: "0756789123", group: "Kikundi Namba 3", date: "2023-01-03", region: "Dodoma", district: "Dodoma", gender: "Female", status: "Not Married"  },
    { id: 4, name: "David Karanja", phone: "0711122233", group: "Kikundi Namba 4", date: "2023-01-04", region: "Arusha", district: "Arusha", gender: "Male", status: "Married" },
    { id: 5, name: "Evelyn Mtemvu", phone: "0722334455", group: "Kikundi Namba 5", date: "2023-01-05", region: "Dar es Salaam", district: "Ilala", gender: "Female", status: "Not Married"  },
    { id: 6, name: "Frank Mkwinda", phone: "0798765432", group: "Kikundi Namba 6", date: "2023-01-06", region: "Mwanza", district: "Ilemela", gender: "Male", status: "Married" },
    { id: 7, name: "Grace Mosi", phone: "0744556677", group: "Kikundi Namba 7", date: "2023-01-07", region: "Tanga", district: "Tanga", gender: "Female", status: "Not Married"  },
    { id: 8, name: "Henry Panga", phone: "0712987654", group: "Kikundi Namba 8", date: "2023-01-08", region: "Kilimanjaro", district: "Moshi", gender: "Male", status: "Not Married" },
    { id: 9, name: "Irene Bahati", phone: "0756781234", group: "Kikundi Namba 9", date: "2023-01-09", region: "Dodoma", district: "Kondoa", gender: "Female", status: "Married" },
    { id: 10, name: "John Mwita", phone: "0789876543", group: "Kikundi Namba 10", date: "2023-01-10", region: "Dar es Salaam", district: "Kinondoni", gender: "Male", status: "Married" },
    // ... Add more entries here ...
    { id: 11, name: "Khadija Said", phone: "0791234567", group: "Kikundi Namba 11", date: "2023-01-11", region: "Mara", district: "Mara", gender: "Female", status: "Married" },
    { id: 12, name: "Lema Rwehabura", phone: "0783456789", group: "Kikundi Namba 12", date: "2023-01-12", region: "Shinyanga", district: "Shinyanga", gender: "Male", status: "Not Married"  },
    { id: 13, name: "Mariam Lissu", phone: "0713456789", group: "Kikundi Namba 12", date: "2023-01-13", region: "Mwanza", district: "Mwanza", gender: "Female", status: "Not Married" },
    { id: 14, name: "Nassor Kihinga", phone: "0751234567", group: "Kikundi Namba 13", date: "2023-01-14", region: "Pemba", district: "Pemba", gender: "Male", status: "Not Married"  },
    { id: 15, name: "Omar Ramadhani", phone: "0745678901", group: "Kikundi Namba 14", date: "2023-01-15", region: "Zanzibar", district: "Zanzibar", gender: "Male", status: "Married" },
    { id: 16, name: "Pendo Sima", phone: "0793456789", group: "Kikundi Namba 15", date: "2023-01-16", region: "Kigoma", district: "Kigoma", gender: "Female", status: "Not Married"  },
    { id: 17, name: "Qadir Nasso", phone: "0712345670", group: "Kikundi Namba 16", date: "2023-01-17", region: "Rukwa", district: "Rukwa", gender: "Male", status: "Married" },
    { id: 18, name: "Rita Shumba", phone: "0786789012", group: "Kikundi Namba 17", date: "2023-01-18", region: "Tabora", district: "Tabora", gender: "Female", status: "Not Married"  },
    { id: 19, name: "Suleiman Chuma", phone: "0754321098", group: "Kikundi Namba 18", date: "2023-01-19", region: "Singida", district: "Singida", gender: "Male", status: "Not Married" },
    { id: 20, name: "Tina Kondo", phone: "0745678900", group: "Kikundi Namba 19", date: "2023-01-20", region: "Dodoma", district: "Dodoma", gender: "Female", status: "Married" },
    // ... continue to add until id: 100
];
...
//         region: ["Dar es Salaam", "Dodoma", "Arusha", "Mwanza", "Tanga"][Math.floor(Math.random() * 5)],
//         district: ["Kinondoni", "Ilala", "Temeke", "Mwanza", "Arusha"][Math.floor(Math.random() * 5)],
//         gender: gender,
//         status: Math.random() > 0.5 ? "Married" : "Not Married"
//     });
// }
